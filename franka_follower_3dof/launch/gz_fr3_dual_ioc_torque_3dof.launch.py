...
def generate_launch_description():
    ...
    follower_lqr = Node(
        package="franka_follower_3dof",
        executable="follower_fr3_j345_exact_lqr",
        namespace="follower",
        name="fr3_j345_exact_lqr",
        output="screen",
        parameters=[{
            "joint_name_prefix": "follower_fr3_",
            "joint_states_topic": "/follower/joint_states",
            "command_topic": "/follower/arm_3dof_cmd/commands",
        }],
    )
    ...
    return LaunchDescription([
        ...
        TimerAction(period=22.0, actions=[leader_lqr]),
        TimerAction(period=24.0, actions=[follower_lqr]),
    ])
