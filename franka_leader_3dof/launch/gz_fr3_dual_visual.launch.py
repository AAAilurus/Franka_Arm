...
def make_robot(pkg_ioc, namespace, arm_prefix, xyz):
...
def generate_launch_description():
    pkg_ioc = get_package_share_directory("franka_leader_3dof")
    ...
    leader = make_robot(pkg_ioc, "leader", "leader_", "-0.50 0 0")
    follower = make_robot(pkg_ioc, "follower", "follower_", "0.50 0 0")
